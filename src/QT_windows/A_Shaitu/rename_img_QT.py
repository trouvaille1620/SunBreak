...
from QT_tools_code.A_Shaitu.Shaitu_tools import Rename_Image_Folder
...
file_path = r'QT_style/A_Shaitu/rename_img_QT.json'
style_dict = json.load(open(file_path, 'r', encoding='utf-8'))


class Rename_img_QT_Demo(QtWidgets.QMainWindow):
    def __init__(self):
        super(Rename_img_QT_Demo, self).__init__()
        self.worker = Rename_Image_Folder()
        self.setup_ui()
    ...
    def setup_ui(self):
        ...
        self.input_path.setPlaceholderText(("重命名格式为“图片所在文件夹名_原图片名”"))
