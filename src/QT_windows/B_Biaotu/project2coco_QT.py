...
from QT_tools_code.B_Biaotu.Biaotu_tools import Project2coco
...
file_path = r'QT_style/B_Biaotu/project2coco_QT.json'
style_dict = json.load(open(file_path, 'r', encoding='utf-8'))


class Project2coco_QT_Demo(QtWidgets.QMainWindow):
    def __init__(self):
        super(Project2coco_QT_Demo, self).__init__()
        self.worker = Project2coco()
        self.setup_ui()
