...
from QT_tools_code.B_Biaotu.Biaotu_tools import Project2txt
...
file_path = r'QT_style/B_Biaotu/project2txt_QT.json'
style_dict = json.load(open(file_path, 'r', encoding='utf-8'))


class Project2txt_QT_Demo(QtWidgets.QMainWindow):
    def __init__(self):
        super(Project2txt_QT_Demo, self).__init__()
        self.worker = Project2txt()
        self.setup_ui()
