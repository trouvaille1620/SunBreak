...
from ..E_Biaozhunbiangeng import delete_via_label_project_QT
...
class Biaozhunbiangeng_window_StackWidget(QWidget):

    def __init__(self):
        super(Biaozhunbiangeng_window_StackWidget, self).__init__()
        self.setup_ui()
    ...
    def setup_ui(self):
        ...
        list_str = ['删除某类标签']
        tools_str = [getattr(delete_via_label_project_QT, "Delete_via_project_label_QT_Demo")]
        for i in range(1):
