...
from QT_tools_code.C_Biaozhutongji.Biaozhutongji_tools import Check_folder_project_img
...
file_path = r'QT_style/C_Biaozhutongji/check_folder_project_img_QT.json'
style_dict = json.load(open(file_path, 'r', encoding='utf-8'))


class Check_folder_project_img_QT_Demo(QtWidgets.QMainWindow):
    def __init__(self):
        super(Check_folder_project_img_QT_Demo, self).__init__()
        self.worker = Check_folder_project_img()
        self.setup_ui()
    ...
    def setup_ui(self):
        ...
        # self.output_path.setPlaceholderText(("保存文件名为check.txt"))
