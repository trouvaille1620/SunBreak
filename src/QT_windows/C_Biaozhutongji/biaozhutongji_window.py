...
from ..C_Biaozhutongji import statistics_project_QT, extract_assign_labelindex_data_QT, no_label_check_project_QT, check_folder_project_img_QT
...
class Biaozhujiancha_window_StackWidget(QWidget):

    def __init__(self):
        super(Biaozhujiancha_window_StackWidget, self).__init__()
        self.setup_ui()
    ...
    def setup_ui(self):
        ...
        list_str = ['无标签框检查', '将某类标签单独取出', '标签统计project', '文件夹及project检查']
        tools_str = [getattr(no_label_check_project_QT, "No_label_check_project_QT_Demo"),
                     getattr(extract_assign_labelindex_data_QT, "Extract_assign_labelindex_data_QT_Demo"),
                     getattr(statistics_project_QT, "Statistics_project_QT_Demo"),
                     getattr(check_folder_project_img_QT, "Check_folder_project_img_QT_Demo"),
                     ]
        for i in range(4):
