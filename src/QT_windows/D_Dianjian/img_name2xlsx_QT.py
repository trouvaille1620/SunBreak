...
from QT_tools_code.D_Dianjian.Dianjian_tools import Img_name2xlsx
...
file_path = r'QT_style/D_Dianjian/img_name2xlsx_QT.json'
style_dict = json.load(open(file_path, 'r', encoding='utf-8'))


class Img_name2xlsx_QT_Demo(QtWidgets.QMainWindow):
    def __init__(self):
        super(Img_name2xlsx_QT_Demo, self).__init__()
        self.worker = Img_name2xlsx()
        self.setup_ui()
    ...
    def setup_ui(self):
        ...
        self.input_path.setPlaceholderText(("选择图片所在文件夹"))
        ...
        self.output_path.setPlaceholderText(("保存文件名为img_name.xlsx"))
